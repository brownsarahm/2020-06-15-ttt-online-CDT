...
humandate: "June 15-16, 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00-5:00pm Central Daylight time"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Sarah Brown", "SherAaron Hurt] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: [""]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
contact: ["sheraaron@carpentries.org","smb@sarahmbrown.org"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
etherpad:  https://pad.carpentries.org/2020-06-15-ttt-online-CDT           # optional: URL for the workshop Etherpad if there is one
eventbrite:           # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
locations:
  - venue: "Online"
    address: "provided to registered attendees via e-mail" https://carpentries.zoom.us/j/FIXME
